...
curl -O https://secondarysoftwaredeploy.s3-us-west-2.amazonaws.com/ExamView_Mac.pkg
echo "Exam View for Mac is installing now..."
  sudo installer -allowUntrusted -pkg ExamView_Mac.pkg -target /

curl -O https://secondarysoftwaredeploy.s3-us-west-2.amazonaws.com/ExamView+Installer.pkg
echo "ExamView content is installing now..."
  sudo installer -allowUntrusted -pkg ExamView+Installer.pkg -target /

curl -O https://secondarysoftwaredeploy.s3-us-west-2.amazonaws.com/ExamView+Player+Installer.pkg
